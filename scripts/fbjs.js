...
FB.getLoginStatus(function(response) {
  if (response.status === 'connected') {
    ...
    FB.api('/me', function(response) {
      var dtext = "";
      dtext += "<p>Welcome, "+response.first_name+"</p>";
...
function postToFeed() {
        ...
        var obj = {
          method: 'feed',
          redirect_uri: 'www.helpnalininow.org',
          link: 'http://www.helpnalininow.org',
          picture: 'http://ambadylab.stanford.edu/helpnalininow/nalinigray.jpg',
          name: 'Nalini needs you',
          caption: 'Spread the word, save a life',
          description: 'Register as a bone marrow donor to increase the odds of finding a match..'
        };
